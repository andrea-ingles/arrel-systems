          ...
          <Link
            ...
            onClick={() => {
              if (typeof window !== 'undefined' && (window as any).plausible) {
                ;(window as any).plausible('CTAClick', { props: { position: 'hero', type: 'read-build-log' } })
              }
            }}
          >
            {t('hero.cta_primary')}
          ...
          >
            ...
            <div style={{ padding: '24px' }}>
              ...
              <Link
                ...
                onClick={() => {
                  if (typeof window !== 'undefined' && (window as any).plausible) {
                    ;(window as any).plausible('ContentCardClick', { props: { card: 'build-log', position: 'homepage-preview' } })
                  }
                }}
              >
                {t('cards.build_link')}
          ...
          >
            ...
            <div style={{ padding: '24px' }}>
              ...
              <Link
                ...
                onClick={() => {
                  if (typeof window !== 'undefined' && (window as any).plausible) {
                    ;(window as any).plausible('ContentCardClick', { props: { card: 'featured-technical', position: 'homepage-preview' } })
                  }
                }}
              >
